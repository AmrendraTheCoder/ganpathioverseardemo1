    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-start space-x-4 mb-6">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  your information when you visit our website, use our printing
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  maintaining the confidentiality of your personal and business
                  information. This policy applies to all our services including
                  offset printing, digital printing, UV printing, large format
                  printing, packaging solutions, and related services.
                </p>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  ...
                  <li>
                    Print specifications (quantity, size, paper type, finishing
                    options)
                  </li>
            ...
            <div className="space-y-6">
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  ...
                  <li>Communicate about project status and delivery updates</li>
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  <li>
                    Send promotional materials and special offers (with consent)
                  </li>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <ul className="list-disc pl-6 space-y-1 text-gray-700">
                  ...
                  <li>
                    <strong>Business Partners:</strong> Authorized distributors
                    or suppliers when necessary for order fulfillment
                  </li>
                  <li>
              ...
              <div>
                ...
                <p className="text-gray-700">
                  ...
                  business information with unauthorized parties. All employees
                  and contractors sign confidentiality agreements to protect
          ...
          {/* Cookies & Tracking */}
          <div id="cookies" className="bg-white rounded-lg shadow-md p-8 mb-8">
            <h2 className="text-2xl font-bold mb-6">
          ...
          <div
            ...
            className="bg-white rounded-lg shadow-md p-8 mb-8"
          >
            <h2 className="text-2xl font-bold mb-6">6. Your Privacy Rights</h2>
          ...
          >
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold mb-3">Services We Use</h3>
                <p className="text-gray-700 mb-3">
            ...
            <div className="space-y-6">
              ...
              <div className="grid gap-4">
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-700">
                    Retained for 7 years after last transaction for business and
                    tax purposes.
                  </p>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                ...
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-700">
                    Aggregated data retained for 26 months for business analysis
                    purposes.
                  </p>
                </div>
                <div className="border border-gray-200 rounded-lg p-4">
                  ...
                  <p className="text-gray-700">
                    Retained until you opt-out or withdraw consent, then deleted
                    within 30 days.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-orange-50 border-l-4 border-orange-400 p-4 rounded">
                <p className="text-orange-800">
                  ...
                  immediately. We will delete such information from our records
                  promptly.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                ...
                <ul className="list-disc pl-6 space-y-1 text-blue-800">
                  ...
                  <li>
                    Material changes affecting your rights: Explicit consent may
                    be required
                  </li>
                </ul>
              </div>
          ...
          {/* Contact Information */}
          <div id="contact" className="bg-white rounded-lg shadow-md p-8 mb-8">
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-700">info@ganpathioverseas.com</p>
                    </div>
                  </div>
