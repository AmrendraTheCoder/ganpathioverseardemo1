          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600">
                ...
                providing comprehensive printing solutions for businesses of all
                sizes. Our dedication to excellence has earned us a reputation
                as a trusted partner for all printing needs.
              </p>
            </div>
